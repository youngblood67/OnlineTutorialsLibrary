    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="group-btn-basket">
                <button id="btn-buy-basket" type="button" class="btn btn-success" data-dismiss="modal">Acheter</button>
                <button id="btn-clear-basket" type="button" class="btn btn-warning" data-dismiss="modal">Vider</button>
            </div>
        </div>
    </div>
</div>
